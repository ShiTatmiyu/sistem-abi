...
<link rel="stylesheet" href="/css/create.css">
        ...
        <h1 class="title-page">Edit murid</h1>
        <form method="post" action="/updatewm/<?= $walimurid['id_walimurid'] ?>" enctype="multipart/form-data">
        <?= csrf_field(); ?>
            <div class="form-list">
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <input class="form-input <?= (isset($errors['nisn_murid'])) ? 'is-invalid' : ''; ?>" type="text" id="nisn" name="nisn_murid" autofocus value="<?= $walimurid['nisn_murid'] ?>">
                    <br>
