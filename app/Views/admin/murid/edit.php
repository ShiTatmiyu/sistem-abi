...
<link rel="stylesheet" href="/css/create.css">
        ...
        <form method="post" action="/updatemr/<?= $murid['nisn'] ?>" enctype="multipart/form-data">
        <?= csrf_field(); ?>
            <div class="form-list">
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <input class="form-input <?= (isset($errors['kelas'])) ? 'is-invalid' : ''; ?>" type="text" id="kelas" name="kelas" autofocus value="<?= $murid['kelas'] ?>">
                    <br>
