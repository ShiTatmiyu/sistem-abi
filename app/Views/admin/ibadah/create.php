...
<link rel="stylesheet" href="/css/create_admin.css">
        ...
        <form method="post" action="/ibadah/store" enctype="multipart/form-data">
        <?= csrf_field(); ?>
            <div class="form-list">
                <div class="form-row">
                    <label for="nama">Nama Ibadah : </label><br>
                    <input class="form-input <?= (isset($errors['nama_ibadah'])) ? 'is-invalid' : ''; ?>" type="text" id="nama" name="nama_ibadah" autofocus value="<?= old('nama_ibadah'); ?>">
                    <br>
                ...
                <div class="form-row">
                    ...
                    <input class="form-input <?= (isset($errors['hukum_ibadah'])) ? 'is-invalid' : ''; ?>" type="text" id="hukum" name="hukum_ibadah" autofocus value="<?= old('hukum_ibadah'); ?>">
                    <br>
                ...
                <div class="form-row">
                    ...
                    <input class="form-input <?= (isset($errors['jadwal_ibadah'])) ? 'is-invalid' : ''; ?>" type="text" id="jadwal" name="jadwal_ibadah" autofocus value="<?= old('jadwal_ibadah'); ?>">
                    <br>
