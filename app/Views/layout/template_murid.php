        ...
        <div class="wrapper">
            ...
            <div class="sidebar">
                <div class="sidebar-menu">
                    ...
                    <li class="item">
                        <a href="/murid/dashboard" class="menu-btn">
                            <i class="fas fa-desktop"></i><span>Dashboard</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="/ibadah2" class="menu-btn">
                        <i class="fa-solid fa-mosque"></i><span>Data Ibadah</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="/absen2" class="menu-btn">
                        <i class="fa-solid fa-pencil-alt"></i><span>Absen Ibadah</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="/murid-profil/<?= session('user_id') ?>" class="menu-btn">
