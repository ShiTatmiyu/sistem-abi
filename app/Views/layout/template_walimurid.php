        ...
        <div class="wrapper">
            ...
            <div class="sidebar">
                <div class="sidebar-menu">
                    ...
                    <li class="item">
                        <a href="/walimurid/dashboard" class="menu-btn">
                            <i class="fas fa-desktop"></i><span>Dashboard</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="/ibadahwm2" class="menu-btn">
                        <i class="fa-solid fa-mosque"></i><span>Data Ibadah</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="/laporan2" class="menu-btn">
                        <i class="fa-solid fa-sticky-note"></i><span>Laporan Ibadah</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="/walimurid-profil/<?= session('user_id') ?>" class="menu-btn">
